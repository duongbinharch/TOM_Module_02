...
//ProjectsManager class giúp ghi và hiển thị các project cards, bằng các thêm project mới vào mảng list và hiển thị ra UI, 
//Nó cũng có newProject method để tạo project mới từ data theo định dạng IProject, khi có data nó sẽ đuoọc thêm vào mảng list và hiển thị ra UI, trả về project mới
